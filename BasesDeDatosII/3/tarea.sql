...
-- Un índice del tipo unique sobre la llave primaria idpersona de la tabla persona.
...
-- Un índice del tipo unique sobre la llave primaria idnacionalidad de la tabla nacionalidad.
